...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, price, category, data, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, product.create({ name: name_1, price: price, category: category })];
            case 1:
                data = _a.sent();
                res.json(data);
                return [3 /*break*/, 3];
...
var updateProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, name_2, price, category, data, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                price = req.body.price;
                category = req.body.category;
                return [4 /*yield*/, product.update({ id: id, name: name_2, price: price, category: category })];
            case 1:
                data = _a.sent();
                res.json(data);
                return [3 /*break*/, 3];
